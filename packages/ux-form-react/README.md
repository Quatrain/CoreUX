...
- **Mantine Integration**: Heavily utilizes `@quatrain/ux` (Mantine) for beautiful, cohesive design right out of the box.

## Usage

```tsx
import { DynamicForm } from '@quatrain/ux-form-react';
